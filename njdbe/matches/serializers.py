...
class MatchSummarySerializer(serializers.ModelSerializer):
    class Meta:
        model  = MatchSummary
        fields = ['id','home_score','away_score','scorers','assists',
                  'yellow_cards','red_cards','substitutions',
                  'possession','shots_on_target','fouls','man_of_the_match']
...
class MatchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Match
        fields = ['id','opponent','date','venue','competition','status','summary','photos']
