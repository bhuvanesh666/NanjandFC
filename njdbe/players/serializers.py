...
class PlayerDocumentAdminSerializer(serializers.ModelSerializer):
    ...
    def get_player(self, obj):
        return {'id': obj.player.id, 'user': {'username': obj.player.user.username}}
...
class PlayerProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = PlayerProfile
        fields = ['id','user','photo','position','jersey_number','dob','bio',
                  'goals','assists','matches_played','yellow_cards','red_cards','documents']
...
class PlayerStatsAdminSerializer(serializers.ModelSerializer):
    class Meta:
        model  = PlayerProfile
        fields = ['id','photo','position','jersey_number','dob','bio',
